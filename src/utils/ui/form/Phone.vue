...
<div>
  ...
  <p class="control has-icon">
    <input :placeholder="placeholder" v-model="phone" ref="phone" :value="value" @input="applyMask($event.target.value)" @change="$emit('input', $event.target.value)" :class="{ 'input': true, 'is-danger': hasError }"></input>
